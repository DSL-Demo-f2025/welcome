...
**[Join](https://github.com/DSL-Demo-f2025/welcome/issues/new/choose)** issue in this repo (the
*New issue* button) and paste the enrolment code the teaching team emailed to your Hertie
address.
